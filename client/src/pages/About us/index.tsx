...
const teamMembers = [
  ...
  },
  {
    ...
    role: "Member",
    msv: "22028283",
    imageUrl: "https://cdn1.iconfinder.com/data/icons/user-pictures/100/boy-1024.png",
  },
  ...
  return (
    <Layout>
      <div>
        ...
        <p className="mb-4 text-lg text-center">Class: INT2041 1 - Human Machine Interaction</p>
